...
ALTER TABLE public.campaign_historic OWNER TO {{ postgres_user }};
...
ALTER TABLE public.contact_in_campaign_historic OWNER TO {{ postgres_user }};
...
ALTER TABLE public.incidence_rules_historic OWNER TO {{ postgres_user }};
...
ALTER TABLE public.incidence_rules_disposition_historic OWNER TO {{ postgres_user }};
