...
BEGIN
  IF NOT EXISTS (SELECT FROM pg_roles WHERE rolname = '{{ postgres_user }}') THEN
    EXECUTE format('CREATE ROLE %I WITH LOGIN', '{{ postgres_user }}');
  END IF;
END$$;

-- crea la DB sólo si no existe
SELECT 'CREATE DATABASE omnidialer WITH OWNER {{ postgres_user }} TEMPLATE template1 ENCODING ''UTF8'';'
...
--
-- Name: jobs; Type: TABLE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.jobs OWNER TO {{ postgres_user }};

--
-- Name: system.control; Type: TABLE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.system_control OWNER TO {{ postgres_user }};

INSERT INTO public.system_control (id, is_active) VALUES (true, true);

--
-- Name: campaign; Type: TABLE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.campaign OWNER TO {{ postgres_user }};

--
-- Name: campaign_id_seq; Type: SEQUENCE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.campaign_id_seq OWNER TO {{ postgres_user }};

--
-- Name: campaign_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: {{ postgres_user }}
--

ALTER SEQUENCE public.campaign_id_seq OWNED BY public.campaign.id;

--
-- Name: contact; Type: TABLE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.contact OWNER TO {{ postgres_user }};

--
-- Name: contact_id_seq; Type: SEQUENCE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.contact_id_seq OWNER TO {{ postgres_user }};

--
-- Name: contact_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: {{ postgres_user }}
--

ALTER SEQUENCE public.contact_id_seq OWNED BY public.contact.id;

--
-- Name: contact_in_campaign; Type: TABLE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.contact_in_campaign OWNER TO {{ postgres_user }};

--
-- Name: contact_in_campaign_id_seq; Type: SEQUENCE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.contact_in_campaign_id_seq OWNER TO {{ postgres_user }};

--
-- Name: contact_in_campaign_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: COLUMN contact_in_campaign.id_campaign; Type: COMMENT; Schema: public; Owner: {{ postgres_user }}
--

COMMENT ON COLUMN public.contact_in_campaign.id_campaign IS 'foreign key to campaign table';

--
-- Name: COLUMN contact_in_campaign.id_contact; Type: COMMENT; Schema: public; Owner: {{ postgres_user }}
--

COMMENT ON COLUMN public.contact_in_campaign.id_contact IS 'link to contact table';

--
-- Name: incidence_rules; Type: TABLE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.incidence_rules OWNER TO {{ postgres_user }};

--
-- Name: incidence_rules_id_seq; Type: SEQUENCE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.incidence_rules_id_seq OWNER TO {{ postgres_user }};

--
-- Name: incidence_rules_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: {{ postgres_user }}
--

ALTER SEQUENCE public.incidence_rules_id_seq OWNED BY public.incidence_rules.id;

--
-- Name: campaign id; Type: DEFAULT; Schema: public; Owner: {{ postgres_user }}
--

ALTER TABLE ONLY public.campaign ALTER COLUMN id SET DEFAULT nextval('public.campaign_id_seq'::regclass);

--
-- Name: contact id; Type: DEFAULT; Schema: public; Owner: {{ postgres_user }}
--

ALTER TABLE ONLY public.contact ALTER COLUMN id SET DEFAULT nextval('public.contact_id_seq'::regclass);

--
-- Name: incidence_rules id; Type: DEFAULT; Schema: public; Owner: {{ postgres_user }}
--

ALTER TABLE ONLY public.incidence_rules ALTER COLUMN id SET DEFAULT nextval('public.incidence_rules_id_seq'::regclass);

--
-- Name: contact_in_campaign id; Type: DEFAULT; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: campaign campaign_pkey; Type: CONSTRAINT; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: contact contact_pkey; Type: CONSTRAINT; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: incidence_rules incidence_rules_pkey; Type: CONSTRAINT; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: contact_in_campaign primary_key_contact_in_campaign; Type: CONSTRAINT; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: fki_foreign_key_contact; Type: INDEX; Schema: public; Owner: {{ postgres_user }}
--

CREATE INDEX fki_foreign_key_contact ON public.contact_in_campaign USING btree (id_contact);

--
-- Name: fki_foreign_key_campaign; Type: INDEX; Schema: public; Owner: {{ postgres_user }}
--

CREATE INDEX fki_foreign_key_campaign ON public.contact_in_campaign USING btree (id_campaign);

--
-- Name: incidence_rules_campaign_id_707899e9; Type: INDEX; Schema: public; Owner: {{ postgres_user }}
--

CREATE INDEX incidence_rules_campaign_id_707899e9 ON public.incidence_rules USING btree (campaign_id);

--
-- Name: contact_in_campaign foreign_key_campaign; Type: FK CONSTRAINT; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: contact_in_campaign foreign_key_contact; Type: FK CONSTRAINT; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: incidence_rules re_campaign_id_707899e9_fk_ominicont; Type: FK CONSTRAINT; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: incidence_rules_disposition; Type: TABLE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.incidence_rules_disposition OWNER TO {{ postgres_user }};

--
-- Name: incidence_rules_disposition_id_seq; Type: SEQUENCE; Schema: public; Owner: {{ postgres_user }}
--
...
ALTER TABLE public.incidence_rules_disposition_id_seq OWNER TO {{ postgres_user }};

--
-- Name: incidence_rules_disposition_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: {{ postgres_user }}
--

ALTER SEQUENCE public.incidence_rules_disposition_id_seq OWNED BY public.incidence_rules_disposition.id;

--
-- Name: incidence_rules_disposition id; Type: DEFAULT; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: incidence_rules_disposition incidence_rules_disposition_pkey; Type: CONSTRAINT; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: incidence_rules_disposition_campaign_disposition_id_707899e9; Type: INDEX; Schema: public; Owner: {{ postgres_user }}
--
...
--
-- Name: incidence_rules_disposition re_campaign_id_707899ea_fk_ominicont; Type: FK CONSTRAINT; Schema: public; Owner: {{ postgres_user }}
--
